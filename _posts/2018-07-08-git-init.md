...
Having used Git as my primary VCS since learning[^5] it at my first co-op placement (thx [pymetrics][pymetrics]!) I have really enjoyed how I can usually just run `type git` in any terminal located anywhere to determine whether my capabilities. Not being tied to an IDE's implementation, and also not having to install any other tooling, helps me immediately hit the ground running wherever & whenever.
...
---
[^1]: This number is still in the double digits but it's still ticking upwards :D
[^2]: VCS isn't just for distributed work! I found myself using Git a ton during my undergrad. It's nice to see your progress and also have regular checkpoints of work that you can revert back inevitably. It also makes sharing work a breeze.
